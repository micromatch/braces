module.exports = [
  ...
  ['d{a..Z..5}b', ['dab','d\\b']], // minimatch removes escaping for some reason
  ['ff{c,b,a}', ['ffa','ffb','ffc']],
  ['f{d,e,f}g', ['fdg','feg','ffg']],
  ['PRE-{a,b}{{a,b},a,b}-POST', ['PRE-aa-POST','PRE-ab-POST','PRE-ba-POST','PRE-bb-POST']],
  ...
  ['{3..3}', ['3']],
  ['{a,\\{a,b}c}', [ 'ac}', '{ac}', 'bc}' ]],
  ['{a,b\\}c,d}', ['{a,b}c,d}']], // Bash expects ['a','b}c','d']
  ['{a,b{c,d}', ['{a,bc','{a,bd']],
  ['{a,b}c,d}', ['ac,d}','bc,d}']],
  ...
  ['{abc}', ['abc']],
  ['{a{,b}', ['{a','{ab']],
  ['{a},b}', ['a,b}']], // Bash throws a parse error
  ['{f..1}', ['{f..1}']],
  ['{f..a}', ['a','b','c','d','e','f']],
  ['{f..f}', ['f']],
  ['{klklkl}{1,2,3}', ['klklkl1','klklkl2','klklkl3']],
  ['{l,n,m}xyz', ['lxyz','mxyz','nxyz']],
  ['{x,y{,}g}', ['x','yg']], // Bash includes duplicates
  ['{x,y{}g}', ['x','y{}g']],
