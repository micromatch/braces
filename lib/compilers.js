...
module.exports = function(braces) {
  ...
  braces.compiler
    ...
    .set('brace.close', function(node) {
      ...
      if (isEmbraced(node, this.options) || noInner(node)) {
...
function isEmbraced(node, options) {
  return (isEscaped(node.parent) && options.expand) || options.makeRe;
}
