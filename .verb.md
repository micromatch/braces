...
Last, but perhaps most important of all, unlike [brace-expansion][] and [minimatch][], braces will not freeze your application when a user passes a complex brace pattern (feeling brave? try expanding `a/{1..10000000}` with minimatch :)
