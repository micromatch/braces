...
- **generates results faster**: can handle even the most complex patterns that cause other implementations like [minimatch][] and Bash to freeze (feeling brave? try expanding `a/{1..10000000}` with minimatch :)
